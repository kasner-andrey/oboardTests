...
class ObjPage {
    ...
    chooseSelectionOptionNewOkrButton(buttonName) {
        return commonHelper.chooseElementByText(this.chooseSelectionOptionNewOkrButton(), buttonName);
    }
